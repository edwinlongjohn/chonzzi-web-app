...
export const COPY = {
  ...
  cta1: "A personality tells you how you respond to money. A plan decides what to do about it.",
  cta2: "Money Simplified takes a personality like yours and builds the budget, the savings system and the plan around it. Built for Nigerian money, by someone who manages it daily. The tools and the course are at the link below.",
